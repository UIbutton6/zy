...
<div>
  <a-row :gutter="16" type="flex" justify="space-between">
    ...
    <a-col :span="6">
      <a-card title="小区数量" :bordered="false">
        <p><b>{{data2}}</b> m2</p>
      </a-card>
    </a-col>
    <a-col :span="6">
      <a-card title="平均温度" :bordered="false">
        <p><b>{{data3}}</b> GJ</p>
      </a-card>
    </a-col>
    <a-col :span="6">
      <a-card title="告警用户" :bordered="false">
        <p><b>{{data4}}</b> GJ</p>
      </a-card>
    </a-col>
  </a-row>
  ...
  <a-row :gutter="16" type="flex" justify="space-between" style="margin-top: 20px;">
    <a-col :span="12">
      <a-card title="用户室温分布图" :bordered="false">
        <div id="chart1"></div>
      </a-card>
    </a-col>
    <a-col :span="12">
      <a-card title="平均温度排行" :bordered="false">
        <div id="chart2"></div>
      </a-card>
    </a-col>
  </a-row>
