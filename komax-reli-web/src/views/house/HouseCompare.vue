  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: '住户地址', dataIndex: 'departName'},
        { title: '温度/更新时间', dataIndex: 'cr' },
        { title: '湿度/更新时间', dataIndex: 'crea' },
        { title: '供水温度/更新时间', dataIndex: 'createTi' },
        { title: '回水温度/更新时间', dataIndex: 'createe' },
        { title: '户热量/更新时间', dataIndex: 'crime' },
