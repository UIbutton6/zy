  ...
  <a-card :visible="visible">
    <a-form :form="form">
      ...
      <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="联系人">
              <a-input style="border:0px;" placeholder="" v-decorator="['contact', {}]"/>
            </a-form-item>
      <a-form-item
        :labelCol="labelCol"
        :wrapperCol="wrapperCol"
      ...
      <a-form-item
        ...
        :wrapperCol="wrapperCol"
        label="备注">
        <a-textarea style="border:0px;" placeholder="" v-decorator="['remarks', {}]"/>
      </a-form-item>
    </a-form>
  </a-card>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      open(record) {
        ...
        console.log(record);
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(record,'contact', 'orgCategory','departName', 'parentId', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'remarks'));
        });
      },
      clearForm() {
        this.form.resetFields();
