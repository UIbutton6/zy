          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              ...
              <a-form-item
                              ...
                              :wrapperCol="wrapperCol"
                              label="联系人">
                              <a-input placeholder="请输入联系人" v-decorator="['contact', {'initialValue':''}]"/>
                            </a-form-item>
              <a-form-item
                :labelCol="labelCol"
                :wrapperCol="wrapperCol"
    ...
    methods: {
      ...
      setValuesToForm(record) {
        ...
        this.$nextTick(() => {
          ...
          this.form.setFieldsValue(pick(record, 'contact','departName','orgCategory', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'remarks'))
        })
      },
