  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/pdaPointLog/add",
          edit: "/reli/pdaPointLog/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'pointId','updateValue','updateTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'pointId','updateValue','updateTime','isDelete'))
      }
