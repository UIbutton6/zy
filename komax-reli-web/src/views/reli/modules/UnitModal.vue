  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="buildingBlocksId" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['buildingBlocksId']" placeholder="请输入buildingBlocksId"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'buildingBlocksId','name','createBy','createTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'buildingBlocksId','name','createBy','createTime','isDelete'))
      },
