  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="question" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['question']" placeholder="请输入question"></a-input>
        </a-form-item>
        <a-form-item label="answer" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['answer']" placeholder="请输入answer"></a-input>
        </a-form-item>
        <a-form-item label="isAnswer" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['isAnswer']" placeholder="请输入isAnswer" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/pdaMessage/add",
          edit: "/reli/pdaMessage/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'question','answer','isAnswer','createBy','createTime','updateBy','updateTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'question','answer','isAnswer','createBy','createTime','updateBy','updateTime','isDelete'))
      },
