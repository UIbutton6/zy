    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="x" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['x']" placeholder="请输入x"></a-input>
        </a-form-item>
        <a-form-item label="y" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['y']" placeholder="请输入y"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/housingEstate/add",
          edit: "/reli/housingEstate/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','x','y','hotStationId','createBy','createTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','x','y','hotStationId','createBy','createTime','isDelete'))
      }
