    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="checkTime" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['checkTime']" placeholder="请输入checkTime"></a-input>
        </a-form-item>
        <a-form-item label="checkUserId" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['checkUserId']" placeholder="请输入checkUserId"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/checkPlan/add",
          edit: "/reli/checkPlan/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','type','checkTime','checkUserId','createTime','remarks','departId','status','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','type','checkTime','checkUserId','createTime','remarks','departId','status','isDelete'))
      }
