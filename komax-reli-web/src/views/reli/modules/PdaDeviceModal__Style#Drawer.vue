  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="branchNumber" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['branchNumber']" placeholder="请输入branchNumber" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="standardBranch" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['standardBranch']" placeholder="请输入standardBranch" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="collectId" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['collectId']" placeholder="请输入collectId"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/pdaDevice/add",
          edit: "/reli/pdaDevice/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'hotStationId','name','type','img','branchNumber','standardBranch','collectId','createBy','createTime','updateBy','updateTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'hotStationId','name','type','img','branchNumber','standardBranch','collectId','createBy','createTime','updateBy','updateTime','isDelete'))
      }
