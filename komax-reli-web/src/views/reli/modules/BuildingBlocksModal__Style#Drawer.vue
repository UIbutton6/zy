  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="housingEstate" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['housingEstate']" placeholder="请输入housingEstate"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/reli/buildingBlocks/add",
          edit: "/reli/buildingBlocks/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'housingEstate','name','createBy','createTime','isDelete'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'housingEstate','name','createBy','createTime','isDelete'))
      }
